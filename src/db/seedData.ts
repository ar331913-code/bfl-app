...
export async function seedInitialData(force = false): Promise<void> {
  ...
  const schedules: RepaymentSchedule[] = [
    ...
    // Schedules for LN-2026-0002 (Akosua Mansa Darko, 8 weekly installments @ 675, 3 paid)
    {
      loanId: 'LN-2026-0002',
      customerId: 'BFL-00002',
      installmentNumber: 1,
      dueDate: format(subDays(today, 21), 'yyyy-MM-dd'),
      expectedAmount: 675,
      principalComponent: 625,
      interestComponent: 50,
      amountPaid: 675,
      remainingBalance: 0,
      status: 'paid',
      lastPaymentDate: format(subDays(today, 21), 'yyyy-MM-dd'),
      penaltyAmount: 0
    },
    {
      loanId: 'LN-2026-0002',
    ...
    // Schedules for LN-2026-0003 (Kwame Yaw Mensah - Fully Paid)
    {
      loanId: 'LN-2026-0003',
      customerId: 'BFL-00003',
      installmentNumber: 1,
      dueDate: format(subDays(today, 33), 'yyyy-MM-dd'),
      expectedAmount: 550,
      principalComponent: 500,
      interestComponent: 50,
      amountPaid: 550,
      remainingBalance: 0,
      status: 'paid',
      lastPaymentDate: format(subDays(today, 33), 'yyyy-MM-dd'),
      penaltyAmount: 0
    },
    {
      loanId: 'LN-2026-0003',
      ...
      remainingBalance: 0,
      status: 'paid',
      lastPaymentDate: format(subDays(today, 26), 'yyyy-MM-dd'),
      penaltyAmount: 0
    },
    {
      loanId: 'LN-2026-0003',
      customerId: 'BFL-00003',
      installmentNumber: 3,
      dueDate: format(subDays(today, 19), 'yyyy-MM-dd'),
      expectedAmount: 550,
      principalComponent: 500,
      interestComponent: 50,
      amountPaid: 550,
      remainingBalance: 0,
      status: 'paid',
      lastPaymentDate: format(subDays(today, 19), 'yyyy-MM-dd'),
      penaltyAmount: 0
    },
    {
      loanId: 'LN-2026-0003',
      ...
      remainingBalance: 0,
      status: 'paid',
      lastPaymentDate: format(subDays(today, 12), 'yyyy-MM-dd'),
      penaltyAmount: 0
    },
    // Schedules for LN-2026-0004 (Grace Serwaa Osei - Overdue)
    {
      loanId: 'LN-2026-0004',
      customerId: 'BFL-00004',
      installmentNumber: 1,
    ...
    },
    {
      ...
      customerId: 'BFL-00004',
      installmentNumber: 2,
      dueDate: format(subDays(today, 11), 'yyyy-MM-dd'),
      expectedAmount: 1100,
      principalComponent: 1000,
      interestComponent: 100,
      amountPaid: 0,
    ...
    },
    {
      ...
      customerId: 'BFL-00004',
      installmentNumber: 3,
      dueDate: format(subDays(today, 4), 'yyyy-MM-dd'),
      expectedAmount: 1100,
      principalComponent: 1000,
      interestComponent: 100,
      amountPaid: 0,
