...
export const LoginModal: React.FC = () => {
  ...
  // If already unlocked and authenticated, hide modal
  if (!isLocked && isAuthenticated) return null;
  // If showing landing page, do not render modal over it
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-slate-950/90 via-navy-950/95 to-slate-900/95 backdrop-blur-md p-4 animate-fade-in">
      <div className={`w-full max-w-sm bg-white rounded-[32px] shadow-2xl p-6 sm:p-7 flex flex-col border border-slate-200 ${isShaking ? 'animate-bounce' : ''}`}>
        ...
        <div className="flex items-center justify-between mb-3">
          <button
            ...
            className="inline-flex items-center gap-1 text-xs font-bold text-slate-500 hover:text-navy-950 px-2.5 py-1 rounded-xl bg-slate-100 hover:bg-slate-200 transition"
          >
        ...
        <div className="flex flex-col items-center text-center mb-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-700 p-0.5 shadow-lg shadow-sky-500/20 mb-2 flex items-center justify-center">
            <div className="w-full h-full rounded-[14px] bg-gradient-to-br from-sky-600 to-blue-900 flex items-center justify-center text-white">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-xs font-semibold pl-10 pr-3.5 py-3 rounded-2xl border-2 border-slate-200 focus:border-sky-500 focus:outline-none bg-slate-50 focus:bg-white text-navy-950 transition"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-xs font-semibold pl-10 pr-10 py-3 rounded-2xl border-2 border-slate-200 focus:border-sky-500 focus:outline-none bg-slate-50 focus:bg-white text-navy-950 transition"
              />
              <button
                type="button"
