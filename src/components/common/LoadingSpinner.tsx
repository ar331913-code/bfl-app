  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-slate-950/95 backdrop-blur-md p-4 animate-fade-in text-white">
      <div className="relative flex items-center justify-center mb-6">
        {/* Outer Glow Ring */}
        <div className="w-20 h-20 rounded-full border-4 border-sky-500/20 border-t-sky-400 animate-spin shadow-lg shadow-sky-500/20" />
        
        {/* Inner Pulsing Emblem */}
        <div className="absolute w-12 h-12 rounded-2xl bg-gradient-to-br from-sky-400 via-blue-600 to-indigo-900 flex items-center justify-center text-white font-black text-base shadow-inner animate-pulse">
          B
        </div>
      </div>
